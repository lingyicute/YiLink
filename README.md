...
The aar can be compiled from the Golang project [AndroidLibV2rayLite](https://github.com/2dust/) or [AndroidLibXrayLite](https://github.com/2dust/AndroidLibXrayLite).
