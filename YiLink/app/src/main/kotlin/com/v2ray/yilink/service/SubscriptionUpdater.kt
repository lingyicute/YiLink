...
import com.v2ray.yilink.AppConfig.SUBSCRIPTION_UPDATE_CHANNEL
import com.v2ray.yilink.AppConfig.SUBSCRIPTION_UPDATE_CHANNEL_NAME
    ...
    class UpdateTask(context: Context, params: WorkerParameters) :
        ...
        override suspend fun doWork(): Result {
            ...
            for (i in subs) {
                ...
                YilinkConfigManager.importBatchConfig(configs, i.first, false)
