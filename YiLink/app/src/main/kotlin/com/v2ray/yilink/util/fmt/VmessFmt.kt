package com.v2ray.yilink.util.fmt
...
import com.v2ray.yilink.dto.VmessQRCode
...
object VmessFmt {
    ...
    fun parseVmess(str: String): ServerConfig? {
        ...
        if (TextUtils.isEmpty(result)) {
            Log.d(AppConfig.YILINK_PACKAGE, "R.string.toast_decoding_failed")
            return null
        }
        ...
        if (TextUtils.isEmpty(vmessQRCode.add)
            ...
            Log.d(AppConfig.YILINK_PACKAGE, "R.string.toast_incorrect_protocol")
            return null
        }
